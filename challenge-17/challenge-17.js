(function () {
    ...
    */
    ...
    console.log('O mes de março é representado pelo número ' + getMonthNumber('março') + '.');
    console.log('O mes de setembro é representado pelo número ' + getMonthNumber('setembro') + '.');
    console.log('O mes de dezembro é representado pelo número ' + getMonthNumber('dezembro') + '.');
