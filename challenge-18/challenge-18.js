(function () {
    ...
    */
    ...
    console.log(cleanCPF(CPFS[0]));
    console.log(cleanCPF(CPFS[1]));
    console.log(cleanCPF(CPFS[2]));
    console.log(cleanCPF(CPFS[3]));
    ...
    */
    ...
    console.log(text4.replace(/<(\w+)>([^<]+)<\/\w+>/g, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n'));
